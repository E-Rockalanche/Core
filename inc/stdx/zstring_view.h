...
public:
	...
	constexpr view substr( size_type pos = 0, size_type count = npos ) const noexcept
	{
		return view{ m_data, m_size }.substr( pos, count );
	}

	constexpr int compare( view v ) const noexcept
	{
		return view{ m_data, m_size }.compare( v );
	}

	constexpr int compare( size_type pos1, size_type count1, view v ) const noexcept
	{
		return view{ m_data, m_size }.compare( pos1, count1, v );
	}

	constexpr int compare( size_type pos1, size_type count1, view v, size_type pos2, size_type count2 ) const noexcept
	{
		return view{ m_data, m_size }.compare( pos1, count1, v, pos2, count2 );
	}

	constexpr int compare( const CharT* s ) const noexcept
	{
		return view{ m_data, m_size }.compare( s );
	}

	constexpr int compare( size_type pos1, size_type count1, const CharT* s ) const noexcept
	{
		return view{ m_data, m_size }.compare( pos1, count1, s );
	}

	constexpr int compare( size_type pos1, size_type count1, const CharT* s, size_type count2 ) const noexcept
	{
		return view{ m_data, m_size }.compare( pos1, count1, s, count2 );
	}
